...
\end{subfigure}
\caption{What the brain expects the data to look like. Experience with real-world objects suggests that the data are most similar to a slightly angled top view of a 3-dimensional strip such as a ribbon, as shown in (a). As the vanishing point moves further away from the viewer, as in (b), the ribbon plot more closely resembles the sine illusion.} % goldstein S&P 8th edition pg 249
