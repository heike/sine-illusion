...
\label{GeneralQuadraticCorrection} 
\end{figure}
...
Figure \ref{GeneralQuadraticCorrection} shows the correction factor based on a quadratic approximation compared to the untransformed data. 
