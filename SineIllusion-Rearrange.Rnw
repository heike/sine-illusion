...
ushcn.cor <- rbind(ushcn.cor, subset(ushcn.cor2, variable!="Uncorrected"))
ushcn.cor$variable <- factor(ushcn.cor$variable, levels=c("Corrected (w=1)", "Corrected (w=0.36)", "Uncorrected"))

ggplot(aes(x=value, y=temp, group=variable), data=ushcn.cor) + 
  geom_jitter(size=1)+ 
  facet_grid(variable~.) +
...
ushcn.cor <- rbind(ushcn.cor, subset(ushcn.cor2, variable!="Uncorrected"))
ushcn.cor$variable <- factor(ushcn.cor$variable, levels=c("Corrected (w=1)", "Corrected (w=0.40)", "Uncorrected"))

ggplot(aes(x=time, y=value, group=variable), data=ushcn.cor) + 
  geom_jitter(size=1)+ 
