...
\begin{subfigure}[b]{.45\linewidth}
  ...
  \caption{\small All data \todo[inline]{that's an unfortunate caption. 'All data' suggests that  sometimes you do not show all data.}}
  \label{fig:example1}
\end{subfigure}
\begin{subfigure}[b]{.45\linewidth}
  \centering
  ...
  \label{fig:example2}
\end{subfigure}
\caption{\label{fig:exampleFull1} Scatterplots of Ozone and Temperature in Houston, 2011. A loess fit is overlaid in (a); (b) shows residuals from the loess fit along the vertical axis. The increase in variability over the temperature range is more pronounced in the de-trended plot on the right.}
\end{figure}
...
While all three graphs seem to show nonconstant variance along the main trend; in reality, the variance is constant in all of them. Clearly, the illusion does not rely on the periodicity of the function for which it was named, but is a symptom of the change in curvature that comes with it.
