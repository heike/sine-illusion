...
\caption{A replication of Figure 2.16 in \cite{robbins:2005}. Due to the line width illusion the graphs of $y=e^x$ and $y=e^x+1$ appear to converge as $x$ increases.\label{fig:robbins-graph}}
\end{SCfigure}
