...
#ggsave("images/illusion-transformation.pdf", width=6, height=4)
@
\begin{figure}[h!tbp]
\centering
\includegraphics[width=.75\linewidth, keepaspectratio=TRUE]{images/illusion-transformation}
