...
library(multicore)
secantlines <- do.call("rbind", mclapply(seq(0, 2*pi, length=40), function(i) getSecantSegment(i, dframe, sin, cos, function(x) -sin(x))))[-c(1,40),]
