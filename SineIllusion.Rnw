...
<<original, echo=FALSE, fig=TRUE, results='asis', fig.width=5, fig.height=2.6>>=
l <- 1
...
<<original-redo, echo=FALSE, fig=FALSE, include=FALSE>>=
...
\begin{figure}[hbtp]
\centering
<<originalgrid, dependson='data', echo=FALSE, fig=TRUE, results='asis',out.width=".5\\linewidth", fig.width=5, fig.height=2.6>>=
...
\begin{figure}[hbtp]
<<fixingit, dependson='data', echo=FALSE, fig=TRUE, results='asis',out.width='.49\\textwidth', fig.width=5, fig.height=3>>=
...
dframe$a <- max(diff(dframe$ystart))
